    ...
    # A string is considered balanced when every letter in the string appears both in uppercase and lowercase. For example, CATattac is balanced (a, c, t occur in both cases).
    ...
    # examples "azABaabza" returns "ABaab" 
